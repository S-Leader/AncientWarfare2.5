...
public class FileUtils {
    ...
    public static void findFiles(Path root, @Nullable BiConsumer<Path, Path> processor) {
        findFiles(root, null, processor);
    }

    public static void findFiles(Path root, @Nullable Function<Path, Boolean> preprocessor, @Nullable BiConsumer<Path, Path> processor) {
        ...
        try (var files = Files.walk(root)) {
            files.forEach(file -> processor.accept(root, file));
        } catch (IOException e) {
