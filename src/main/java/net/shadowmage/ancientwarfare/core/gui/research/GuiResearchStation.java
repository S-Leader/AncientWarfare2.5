...
public class GuiResearchStation extends GuiContainerBase<ContainerResearchStation> {
    ...
    public void initElements() {
        ...
        addGuiElement(new Label(8, 8 + 18 * 2, I18n.get("guistrings.research.current_goal") + ":"));
        ...
        Button button = new Button(178 - 8 - 110, 8 + 12 + 4, 110, 12, "guistrings.research.research_queue") {
            ...
            protected void onPressed() {
                ...
                Minecraft.getInstance().setScreen(new GuiResearchStationSelection(GuiResearchStation.this, ClientMouseHelper.x(), ClientMouseHelper.y()));
            }
        };
        ...
        invDir = new Button(80, 8 + 3 * 18 + 6, 40, 16, Direction.getTranslationKey(getContainer().tileEntity.inventoryDirection)) {
            @Override
            protected void onPressed() {
        ...
        invSide = new Button(120, 8 + 3 * 18 + 6, 40, 16, Direction.getTranslationKey(getContainer().tileEntity.inventorySide)) {
            @Override
            protected void onPressed() {
    ...
    public void setupElements() {
        ...
        invDir.setText(Direction.getTranslationKey(getContainer().tileEntity.inventoryDirection));
        invSide.setText(Direction.getTranslationKey(getContainer().tileEntity.inventorySide));
    }
