...
public class GuiResearchStationSelection extends GuiContainerBase<ContainerResearchStation> {
    ...
    public GuiResearchStationSelection(GuiResearchStation parent, double x, double y) {
    ...
    public void setupElements() {
        ...
        if (getContainer().researcherName != null) {
            for (String researchName : ResearchTracker.INSTANCE.getResearchableGoals(player.level(), getContainer().researcherName)) {
    ...
    private int addQueuedGoal(int totalHeight, String researchName, boolean removeButton) {
        ...
        String name = I18n.get(g.getDescriptionId());
        if (!removeButton) {
            name = name + " (" + I18n.get("guistrings.research.current_goal") + ")";
        }
    ...
    private int addSelectableGoal(int totalHeight, String researchName) {
        ...
        Label label = new Label(8, totalHeight + 1, g.getDescriptionId());
    ...
    private Tooltip createGoal(Label label, ResearchGoal g) {
        ...
        selectableGoalTooltip.addTooltipElement(new Label(0, 0, I18n.get("guistrings.research.research_time", g.getTotalResearchTime())));
