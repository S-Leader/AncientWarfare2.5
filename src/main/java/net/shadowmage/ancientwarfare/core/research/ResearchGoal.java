...
public class ResearchGoal {
    ...
    public String getDescriptionId() {
        return getDescriptionId(researchName);
    }

    public static String getDescriptionId(String researchName) {
    ...
    public NonNullList<ItemStack> getResourcesForDisplay() {
        ...
        for (Ingredient ingredient : researchResources) {
            java.util.List<ItemStack> candidates = ResearchIngredientDisplay.getDisplayStacks(ingredient);
            if (!candidates.isEmpty()) {
                resources.add(candidates.get(random.nextInt(candidates.size())));
            }
        }
        return resources;
    }
