...
public abstract class ModConfiguration {
    ...
    protected final LegacyConfiguration config;
    public boolean updatedVersion = false;
    public boolean autoExportOnUpdate = false;

    public ModConfiguration(LegacyConfiguration config) {
        this.config = config;
        load();
    }
    ...
    public LegacyConfiguration getConfig() {
        return this.config;
    }
    ...
    public static LegacyConfiguration getConfigFor(String modID) {
        return new LegacyConfiguration(new File(configPathForFiles, modID + ".cfg"));
    }
}
