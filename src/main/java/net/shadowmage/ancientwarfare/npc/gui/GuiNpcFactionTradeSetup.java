...
public class GuiNpcFactionTradeSetup extends GuiContainerBase<ContainerNpcFactionTradeSetup> {
    ...
    public void initElements() {
        ...
        Button templateButton = new Button(170, ySize - 85, xSize - 174, 12, "guistrings.select_trade_template") {
            ...
            protected void onPressed() {
                Minecraft.getInstance().setScreen(new GuiSelectFromList<>(GuiNpcFactionTradeSetup.this, "",
        ...
        Button templateSaveButton = new Button(170, ySize - 69, xSize - 174, 12, "guistrings.save_to_trade_template") {
            @Override
            protected void onPressed() {
                Minecraft.getInstance().setScreen(new GuiTradeTemplateSave(GuiNpcFactionTradeSetup.this));
                refreshGui();
            }
        };
    ...
    private void addTradeControls(final FactionTrade trade, int startHeight, final int tradeNum) {
        ...
        area.addGuiElement(new Label(infoX + 55 + 4, startHeight + 36 + 1, "guistrings.min_level"));
        ...
        NumberInput minLevelInput = new NumberInput(infoX + 55 + 4 + 60, startHeight + 36, 40, trade.getMinLevel(), this) {
            @Override
            public void onValueUpdated(float value) {
                trade.setMinLevel((int) value);
                getContainer().tradesChanged = true;
            }
        };
        minLevelInput.setIntegerValue();
        area.addGuiElement(minLevelInput);
    }
