...
public class GuiTownHallInventory extends GuiContainerBase<ContainerTownHall> {
    ...
    public void initElements() {
        ...
        Button button = new Button(8, 8, 40, 12, "guistrings.npc.death_list") {
            ...
            protected void onPressed() {
                ...
                Minecraft.getInstance().setScreen(new GuiTownHallDeathList(GuiTownHallInventory.this));
            }
        };
    ...
    public void setupElements() {
        ...
        name = new Text(50, 8, 54, getContainer().tileEntity.getName(), this);
        addGuiElement(name);
    ...
    protected boolean onGuiCloseRequested() {
        ...
        if (!getContainer().tileEntity.getName().equals(name.getText()))
