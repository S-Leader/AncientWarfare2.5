...
public class EpicSiegeCompat implements ICompat {
    ...
    public void init() {
        try {
            hostileAI = Class.forName("funwayguy.epicsiegemod.ai.ESM_NearestAttackableTargetGoal");
            EventHandler.INSTANCE.registerAdditionalHostileAICheck(e -> hostileAI.isInstance(e));
        } catch (ClassNotFoundException e) {
            AncientWarfareNPC.LOG.error("Unable to find ESM_NearestAttackableTargetGoal ai class", e);
        }
    }
}
