...
public class Team {
    ...
    public void adjustStandingFor(Level world, FactionData factionData, String factionName, int standingChange, String playerToExclude) {
    ...
    public CompoundTag serializeNBT() {
        ...
        ret.put("playerMembers", NBTHelper.getNBTStringList(playerMembers));
        ret.put("factionStandings", factionStandings.writeToNBT(new CompoundTag()));

        return ret;
    }

    public static Team deserializeNBT(CompoundTag nbt) {
        ResourceLocation teamName = new ResourceLocation(nbt.getString("teamName"));
        Team team = new Team(teamName);
        team.playerMembers = NBTHelper.getStringSet(nbt.getList("playerMembers", Constants.NBT.TAG_STRING));
        team.factionStandings = new FactionEntry(nbt.getCompound("factionStandings"));
        return team;
    }
