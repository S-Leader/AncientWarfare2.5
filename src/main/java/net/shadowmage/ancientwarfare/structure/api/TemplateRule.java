...
public abstract class TemplateRule {
    ...
    public abstract void handlePlacement(Level world, int turns, BlockPos pos, IStructureBuilder builder);

    public abstract void writeRuleData(CompoundTag tag);
    ...
    public abstract void parseRule(CompoundTag tag);
