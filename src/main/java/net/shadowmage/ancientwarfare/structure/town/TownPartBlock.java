...
public class TownPartBlock {
    ...
    public void subdivide(int plotSize) {
        ...
        for (int x = 0; x < xDivs; x++) {
            ...
            xEnd = xStart + (xSize - 1) * quadrant.getXDir().getStepX();
            ...
            for (int z = 0; z < zDivs; z++) {
                ...
                zEnd = zStart + quadrant.getZDir().getStepZ() * (zSize - 1);
                ...
                zStart = zEnd + quadrant.getZDir().getStepZ();
            }

            widthToUse -= plotSize;
            xStart = xEnd + quadrant.getXDir().getStepX();
        }
    }
