...
public class StructurePluginAutomation implements StructureContentPlugin {
    ...
    public void addHandledBlocks(StructurePluginManager manager) {
        ...
        manager.registerBlockHandler(TemplateRuleRotatable.PLUGIN_NAME, AWAutomationBlocks.TORQUE_SHAFT_LIGHT, TemplateRuleRotatable::new, TemplateRuleRotatable::new);
        manager.registerBlockHandler(TemplateRuleRotatable.PLUGIN_NAME, AWAutomationBlocks.TORQUE_SHAFT_MEDIUM, TemplateRuleRotatable::new, TemplateRuleRotatable::new);
        manager.registerBlockHandler(TemplateRuleRotatable.PLUGIN_NAME, AWAutomationBlocks.TORQUE_SHAFT_HEAVY, TemplateRuleRotatable::new, TemplateRuleRotatable::new);
        ...
        manager.registerBlockHandler(TemplateRuleRotatable.PLUGIN_NAME, AWAutomationBlocks.TORQUE_JUNCTION_LIGHT, TemplateRuleRotatable::new, TemplateRuleRotatable::new);
        manager.registerBlockHandler(TemplateRuleRotatable.PLUGIN_NAME, AWAutomationBlocks.TORQUE_JUNCTION_MEDIUM, TemplateRuleRotatable::new, TemplateRuleRotatable::new);
        manager.registerBlockHandler(TemplateRuleRotatable.PLUGIN_NAME, AWAutomationBlocks.TORQUE_JUNCTION_HEAVY, TemplateRuleRotatable::new, TemplateRuleRotatable::new);
        ...
        manager.registerBlockHandler(TemplateRuleRotatable.PLUGIN_NAME, AWAutomationBlocks.TORQUE_DISTRIBUTOR_LIGHT, TemplateRuleRotatable::new, TemplateRuleRotatable::new);
        manager.registerBlockHandler(TemplateRuleRotatable.PLUGIN_NAME, AWAutomationBlocks.TORQUE_DISTRIBUTOR_MEDIUM, TemplateRuleRotatable::new, TemplateRuleRotatable::new);
        manager.registerBlockHandler(TemplateRuleRotatable.PLUGIN_NAME, AWAutomationBlocks.TORQUE_DISTRIBUTOR_HEAVY, TemplateRuleRotatable::new, TemplateRuleRotatable::new);
        ...
        manager.registerBlockHandler(TemplateRuleRotatable.PLUGIN_NAME, AWAutomationBlocks.FLYWHEEL_CONTROLLER_LIGHT, TemplateRuleRotatable::new, TemplateRuleRotatable::new);
        manager.registerBlockHandler(TemplateRuleRotatable.PLUGIN_NAME, AWAutomationBlocks.FLYWHEEL_CONTROLLER_MEDIUM, TemplateRuleRotatable::new, TemplateRuleRotatable::new);
        manager.registerBlockHandler(TemplateRuleRotatable.PLUGIN_NAME, AWAutomationBlocks.FLYWHEEL_CONTROLLER_HEAVY, TemplateRuleRotatable::new, TemplateRuleRotatable::new);
        ...
        manager.registerBlockHandler(TemplateRuleTorqueMultiblock.PLUGIN_NAME, AWAutomationBlocks.FLYWHEEL_STORAGE_LIGHT, TemplateRuleTorqueMultiblock::new, TemplateRuleTorqueMultiblock::new);
        manager.registerBlockHandler(TemplateRuleTorqueMultiblock.PLUGIN_NAME, AWAutomationBlocks.FLYWHEEL_STORAGE_MEDIUM, TemplateRuleTorqueMultiblock::new, TemplateRuleTorqueMultiblock::new);
        manager.registerBlockHandler(TemplateRuleTorqueMultiblock.PLUGIN_NAME, AWAutomationBlocks.FLYWHEEL_STORAGE_HEAVY, TemplateRuleTorqueMultiblock::new, TemplateRuleTorqueMultiblock::new);
