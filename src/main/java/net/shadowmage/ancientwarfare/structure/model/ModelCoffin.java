 ...
 */
@OnlyIn(Dist.CLIENT)
public class ModelCoffin extends LegacyModelBase {
    private LegacyModelRenderer sideBottom;
    private LegacyModelRenderer sideL1;
    private LegacyModelRenderer sideL2;
    private LegacyModelRenderer sideTop;
    private LegacyModelRenderer sideR1;
    private LegacyModelRenderer sideR2;
    private LegacyModelRenderer lid;
    private LegacyModelRenderer bottom;

    public ModelCoffin() {
        textureWidth = 144;
        textureHeight = 80;
        sideR2 = new LegacyModelRenderer(this, 0, 35);
        ...
        bottom = new LegacyModelRenderer(this, 24, 47);
        bottom.setRotationPoint(-8.0F, 22.9F, -8.0F);
        bottom.addBox(0.0F, 0.0F, 0.0F, 16, 1, 32, 0.0F);
        LegacyModelRenderer lidsideR1 = new LegacyModelRenderer(this, 118, 45);
        ...
        LegacyModelRenderer lidsideR2 = new LegacyModelRenderer(this, 90, 27);
        ...
        sideL2 = new LegacyModelRenderer(this, 0, 0);
        ...
        lid = new LegacyModelRenderer(this, 24, 0);
        lid.setRotationPoint(-8.0F, 14.100000000000001F, -8.0F);
        lid.addBox(0.0F, 0.0F, 0.0F, 16, 0, 32, 0.0F);
        LegacyModelRenderer lidsideL2 = new LegacyModelRenderer(this, 90, 0);
        ...
        sideR1 = new LegacyModelRenderer(this, 28, 45);
        ...
        LegacyModelRenderer lidsideTop = new LegacyModelRenderer(this, 90, 0);
        lidsideTop.setRotationPoint(3.0F, -0.11F, 31.0F);
        lidsideTop.addBox(0.0F, 0.0F, 0.0F, 10, 1, 1, 0.0F);
        sideL1 = new LegacyModelRenderer(this, 28, 10);
     ...
     */
    private void setRotateAngle(LegacyModelRenderer modelRenderer, float y) {
        setRotateAngle(modelRenderer, 0F, y, 0F);
    }

    private void setRotateAngle(LegacyModelRenderer modelRenderer, float x, float y, float z) {
