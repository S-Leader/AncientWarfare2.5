...
public class GuiStructureScanner extends GuiContainerBase<ContainerStructureScanner> implements ContainerListener {
    ...
    public GuiStructureScanner(ContainerBase par1Container) {
        ...
        par1Container.addSlotListener(this);
    }
    ...
    public void initElements() {
        ...
        Label label = new Label(8, totalHeight, I18n.get("guistrings.input_name") + ":");
        ...
        validationTypeLabel = new Label(8, totalHeight, I18n.get("guistrings.validation_type") + " " + getContainer().getValidationTypeName());
        ...
        setupValidationButton = new Button(8, totalHeight, 120, 16, "guistrings.setup_validation") {
            ...
            protected void onPressed() {
                Minecraft.getInstance().setScreen(new GuiStructureValidationSettings(GuiStructureScanner.this));
            }
        };
        ...
        selectBiomesButton = new Button(8, totalHeight, 120, 16, "guistrings.select_biomes") {
            @Override
            protected void onPressed() {
                Minecraft.getInstance().setScreen(new GuiStructureBiomeSelection(GuiStructureScanner.this));
            }
        };
        ...
        selectDimensionsButton = new Button(8, totalHeight, 120, 16, "guistrings.select_dimensions") {
            @Override
            protected void onPressed() {
                Minecraft.getInstance().setScreen(new GuiDimensionSelection(GuiStructureScanner.this));
            }
        };
        ...
        selectModsButton = new Button(8, totalHeight, 120, 16, "guistrings.select_mods") {
            @Override
            protected void onPressed() {
                Minecraft.getInstance().setScreen(new GuiModSelection(GuiStructureScanner.this));
            }
        };
    ...
    public void setupElements() {
        ...
        validationTypeLabel.setText(I18n.get("guistrings.validation_type") + " " + getContainer().getValidationTypeName());
    }
    ...
    private void export() {
        ...
        if (!validateName(name)) {
            Minecraft.getInstance().setScreen(new GuiStructureIncorrectName(this));
        } else {
            getContainer().export();
            if (!getContainer().getScannerTile().isPresent()) {
                this.closeGui();
