...
public class GuiStatue extends GuiContainerBase<ContainerStatue> {
    ...
    public GuiStatue(ContainerBase container) {
        super(container, Minecraft.getInstance().getWindow().getGuiScaledWidth(), Minecraft.getInstance().getWindow().getGuiScaledHeight());
        hideGUI = Minecraft.getInstance().options.hideGui;
    ...
    public void setupElements() {
        ...
        addGuiElement(new Button(leftOffset, topY, 100, 14, statueInfo.getStatueEntityName()) {
            ...
            protected void onPressed() {
                Minecraft.getInstance().setScreen(new GuiSelectFromList<>(GuiStatue.this, text, s -> s,
