...
public class RenderHwacha extends RenderVehicleBase {
    ...
    public RenderHwacha(EntityRendererProvider.Context renderManager) {
        super(renderManager);
    }
    ...
    public void renderVehicle(VehicleBase vehicle, double x, double y, double z, float yaw, float tick) {
        ...
        model.setModelPitch(Mth.abs(Trig.getVelocity(vehicle.getDeltaMovement().x, vehicle.getDeltaMovement().y, vehicle.getDeltaMovement().z)) > 0.02f ? -8 : -39);
