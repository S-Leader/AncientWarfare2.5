...
public interface IAmmo {
    ...
    void onImpactWorld(Level world, float x, float y, float z, MissileBase missile, HitResult hit);//called when the entity impacts a world block

    void onImpactEntity(Level world, Entity ent, float x, float y, float z, MissileBase missile);//called when the entity impacts another entity
}
