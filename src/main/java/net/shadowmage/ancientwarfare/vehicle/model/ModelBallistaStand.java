...
@OnlyIn(Dist.CLIENT)
public class ModelBallistaStand extends LegacyModelBase {

    LegacyModelRenderer baseMain;
    LegacyModelRenderer basePillar;
    ...
    public ModelBallistaStand() {
        baseMain = new LegacyModelRenderer(this, "baseMain");
        ...
        basePillar = new LegacyModelRenderer(this, "basePillar");
