...
public class TorqueShaftRenderer extends TorqueTieredRenderer<TileTorqueShaft> {
    ...
    public static final ModelResourceLocation LIGHT_MODEL_LOCATION = new ModelResourceLocation(new ResourceLocation(AncientWarfareCore.MOD_ID + ":automation/torque_shaft"), "light");
    public static final ModelResourceLocation MEDIUM_MODEL_LOCATION = new ModelResourceLocation(new ResourceLocation(AncientWarfareCore.MOD_ID + ":automation/torque_shaft"), "medium");
    public static final ModelResourceLocation HEAVY_MODEL_LOCATION = new ModelResourceLocation(new ResourceLocation(AncientWarfareCore.MOD_ID + ":automation/torque_shaft"), "heavy");
