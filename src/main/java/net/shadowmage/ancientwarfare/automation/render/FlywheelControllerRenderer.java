...
public class FlywheelControllerRenderer extends TorqueTieredRenderer<TileFlywheelController> {
    public static final ModelResourceLocation LIGHT_MODEL_LOCATION = new ModelResourceLocation(new ResourceLocation(AncientWarfareCore.MOD_ID + ":automation/flywheel_controller"), "light");
    public static final ModelResourceLocation MEDIUM_MODEL_LOCATION = new ModelResourceLocation(new ResourceLocation(AncientWarfareCore.MOD_ID + ":automation/flywheel_controller"), "medium");
    public static final ModelResourceLocation HEAVY_MODEL_LOCATION = new ModelResourceLocation(new ResourceLocation(AncientWarfareCore.MOD_ID + ":automation/flywheel_controller"), "heavy");
    ...
    @Override
    protected LegacyModelState handleAdditionalProperties(LegacyModelState state, TileFlywheelController tileEntity) {
        state = super.handleAdditionalProperties(state, tileEntity);
        state = state.setValue(BlockFlywheelController.FLYWHEEL_ROTATION, 0f);
