...
public class WarehouseStockLinkerRenderer implements BlockEntityRenderer<TileWarehouseStockLinker> {
    ...
    @Override
    public void render(TileWarehouseStockLinker tile, float partialTick, PoseStack poseStack, MultiBufferSource buffer, int packedLight, int packedOverlay) {
    ...
    private void renderSignContents(TileWarehouseStockLinker tile, PoseStack poseStack, MultiBufferSource buffer) {
        poseStack.pushPose();
    ...
    private void renderItemIntoGui(ItemStack stack, int x, int y, TileWarehouseStockLinker tile, PoseStack poseStack, MultiBufferSource buffer) {
        poseStack.pushPose();
