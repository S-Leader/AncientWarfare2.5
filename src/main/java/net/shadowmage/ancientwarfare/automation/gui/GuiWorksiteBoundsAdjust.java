    ...
    public void setupElements() {
        ...
        Button b = new Button(48, 12, 40, 12, "guistrings.inventory.direction.north") {
            ...
            protected void onPressed() {
                if (getContainer().max.getZ() >= getContainer().getZ() && (getContainer().min.getX() > getContainer().getX() || getContainer().max.getX() < getContainer().getX())) {
                    getContainer().min = getContainer().min.relative(Direction.NORTH);
                    getContainer().max = getContainer().max.relative(Direction.NORTH);
                    boundsAdjusted = true;
                    refreshGui();
                }
            }
        ...
        b = new Button(48 + 40, 12, 40, 12, "guistrings.inventory.direction.south") {
            ...
            protected void onPressed() {
                if (getContainer().min.getZ() <= getContainer().getZ() && (getContainer().min.getX() > getContainer().getX() || getContainer().max.getX() < getContainer().getX())) {
                    getContainer().min = getContainer().min.relative(Direction.SOUTH);
                    getContainer().max = getContainer().max.relative(Direction.SOUTH);
                    boundsAdjusted = true;
                    refreshGui();
                }
            }
        ...
        b = new Button(48 + 80, 12, 40, 12, "guistrings.inventory.direction.west") {
            ...
            protected void onPressed() {
                if (getContainer().max.getX() >= getContainer().getX() && (getContainer().min.getZ() > getContainer().getZ() || getContainer().max.getZ() < getContainer().getZ())) {
                    getContainer().min = getContainer().min.relative(Direction.WEST);
                    getContainer().max = getContainer().max.relative(Direction.WEST);
                    boundsAdjusted = true;
                    refreshGui();
                }
            }
        ...
        b = new Button(48 + 120, 12, 40, 12, "guistrings.inventory.direction.east") {
            ...
            protected void onPressed() {
                if (getContainer().min.getX() <= getContainer().getX() && (getContainer().min.getZ() > getContainer().getZ() || getContainer().max.getZ() < getContainer().getZ())) {
                    getContainer().min = getContainer().min.relative(Direction.EAST);
                    getContainer().max = getContainer().max.relative(Direction.EAST);
                    boundsAdjusted = true;
                    refreshGui();
                }
            }
        ...
        b = new Button(48 + 40, 24, 40, 12, "XSIZE+") {
            ...
            protected void onPressed() {
                ...
                if (getContainer().min.getX() < getContainer().getX()) {
                    getContainer().min = getContainer().min.relative(Direction.WEST, offset);
                    boundsAdjusted = true;
                    refreshGui();
                } else {
                    getContainer().max = getContainer().max.relative(Direction.EAST, offset);
                    boundsAdjusted = true;
                    refreshGui();
                }
            }
        ...
        b = new Button(48 + 120, 24, 40, 12, "ZSIZE+") {
            ...
            protected void onPressed() {
                ...
                if (getContainer().min.getZ() < getContainer().getZ()) {
                    getContainer().min = getContainer().min.relative(Direction.NORTH, offset);
                    boundsAdjusted = true;
                    refreshGui();
                } else {
                    getContainer().max = getContainer().max.relative(Direction.SOUTH, offset);
                    boundsAdjusted = true;
                    refreshGui();
                }
            }
