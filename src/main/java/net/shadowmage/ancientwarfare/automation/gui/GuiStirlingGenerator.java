...
public class GuiStirlingGenerator extends GuiContainerBase<ContainerStirlingGenerator> {
    ...
    public void initElements() {
        ...
        energyLabel = new Label(8, 8, I18n.get("guistrings.automation.current_energy", String.format("%.2f", getContainer().energy)));
    ...
    public void setupElements() {
        energyLabel.setText(I18n.get("guistrings.automation.current_energy", String.format("%.2f", getContainer().energy)));
        float progress = 0;
